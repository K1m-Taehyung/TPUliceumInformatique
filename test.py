...
import math
def menu6():
    question = ('Какой формулой воспользуемся, дружище?')
    print (question)
    print ('1. I определяется как V/(XY) (размеры экрана по горизонтали и по вертикали; произведение XY - разрешающая способность экрана)')
    print ('2. I определяется как log2(K) ')
    name =int(input('Введите опцию: \n '))
    if name==1:
        V=int(input ('Вставьте значение для V:  \n '))
        X=int(input ('Вставьте значение для X:  \n '))
        Y=int(input ('Вставьте значение для Y:  \n '))
        print(V/(X*Y))
        print ('Всегда пожалуйста :) ')
    elif name==2:
        K=int(input ('Вставьте значение для K: \n '))
...
def menu8():
    ...
    name =int(input('Введите опцию: \n '))
    if name==1:
         print ('V определяется как I умноженное на XY (размеры экрана по горизонтали и по вертикали; произведение XY - разрешающая способность экрана')
         I=int(input ('Вставьте значение для I:  \n '))
         X=int(input ('Вставьте значение для X:  \n '))
         Y=int(input ('Вставьте значение для Y:  \n'))
         print(I*X*Y)
         ...
         print ('XY (размеры экрана по горизонтали и по вертикали; произведение XY - разрешающая способность экрана) определяется как V/I')
         I=int(input ('Вставьте значение для I:  \n '))
         V=int(input ('Вставьте значение для H:  \n '))
         print(V/I)
         print ('Всегда пожалуйста :) ')
    else:
         print('не понимаю :(')        
